...
export const produtos = [
    {
        ...
        seoTitulo: 'Soda Cáustica em Escamas 500 g, 98% de pureza | Escorpião',
        seoDescricao:
            'Soda cáustica em escamas Escorpião com 98% de pureza, embalagem de 500 g para uso doméstico e fabricação de sabão. Compre pelo WhatsApp ou em revendedores.',
        descricao:
    ...
    },
    {
        ...
        seoTitulo: 'Soda Cáustica em Escamas 1 kg, 98% de pureza | Escorpião',
        seoDescricao:
            'Soda cáustica em escamas Escorpião com 98% de pureza, embalagem de 1 kg para distribuidores e uso industrial de menor escala. Compre pelo WhatsApp.',
        descricao:
    ...
    },
    {
        ...
        seoTitulo: 'Soda Cáustica Líquida para sabão e indústria | Escorpião',
        seoDescricao:
            'Soda cáustica líquida Escorpião: hidróxido de sódio em solução para fabricar sabão caseiro e industrial, tratar água e ajustar pH. Compre pelo WhatsApp.',
        descricao:
    ...
    },
    {
        ...
        seoTitulo: 'Percarbonato de Sódio, alvejante sem cloro | Escorpião Casa',
        descricao:
    ...
    },
    {
        ...
        seoTitulo: 'Bicarbonato de Sódio multiuso para limpeza | Escorpião Casa',
        descricao:
