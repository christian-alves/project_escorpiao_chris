        ...
        <section class="max-w-6xl mx-auto px-6 pt-32 pb-6 scroll-mt-32">
                ...
                <div
                    ...
                    <div class="flex flex-col md:flex-row md:items-end gap-4 mb-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-xs font-bold tracking-widest text-red-400 uppercase font-montserrat mb-0.5">
                                    Linha Principal</p>
                    ...
                    <div class="h-px bg-gradient-to-r from-red-300 via-red-100 to-transparent mb-10 opacity-60"></div>
            ...
            <div class="mt-20 reveal-element">
                <div
                    ...
                    <div class="absolute top-0 left-0 w-2/3 h-1 bg-gradient-to-r from-[#184691] via-[#2a5cb5] to-transparent">
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row md:items-end gap-4 mb-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-xs font-bold tracking-widest uppercase font-montserrat mb-0.5"
                                    style="color: #184691;">Nova Linha</p>
                                <h2 class="text-2xl font-extrabold text-gray-800 font-montserrat tracking-tight leading-tight">
                                    Linha de Limpeza</h2>
                            </div>
                        </div>
                    ...
                    <div class="h-px mb-10"
                        style="background: linear-gradient(to right, #184691, #184691, transparent); opacity: 0.2;"></div>
