<template>
    <div v-if="produto" style="background-color: #faf4ef; overflow-x: hidden;">
        <section class="max-w-6xl mx-auto px-6 pt-32 pb-20">
            ...
            <div
                ...
                <div class="absolute top-0 left-0 w-2/3 h-1 bg-gradient-to-r from-red-700 via-red-400 to-transparent">
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div>
                        <p class="text-xs font-bold tracking-widest text-red-400 uppercase font-montserrat mb-2">
                        ...
                        <p class="text-xs font-bold tracking-widest uppercase font-montserrat mb-4 text-red-700">
                            Aplicações
                        </p>
                        <ul class="space-y-3 mb-10">
                            <li v-for="uso in produto.usos" :key="uso" class="flex items-start gap-3">
                                <div class="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 bg-red-50">
                                    <Check class="w-3.5 h-3.5 text-red-700" />
                                </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <NuxtLink to="/onde-comprar">
                                <button
                                    class="w-full sm:w-auto group relative overflow-hidden border border-red-700 bg-red-700 text-white px-10 py-3 rounded-full font-semibold tracking-wide transition-all duration-300 hover:bg-white z-10 hover:shadow-[0_8px_30px_rgb(185,28,28,0.4)] hover:-translate-y-1">
                                    <span class="relative z-10 group-hover:text-red-700">ONDE COMPRAR</span>
                                </button>
                            </NuxtLink>
                            <NuxtLink to="/contato">
                                <button
                                    class="w-full sm:w-auto border-2 border-red-700 text-red-700 px-10 py-3 rounded-full font-semibold tracking-wide transition-all duration-300 hover:bg-red-50 hover:-translate-y-1">
                                    FALE CONOSCO
                                </button>
                            </NuxtLink>
                        </div>
